...
export const AppShell = () => {
  ...
  const screens: Record<Tab, React.ReactNode> = {
    ...
    planner: <ErrorBoundary><PlannerScreen recipes={recipes} fridge={fridge} products={products} profile={profile} lang={tweaks.lang} planner={planner} setPlanner={setPlanner} favoriteRecipes={favoriteRecipes} onViewRecipe={(id) => { setTab('recipes'); setPendingOpenRecipeId(id); }} /></ErrorBoundary>,
  };

...
describe('useAppData – loadAll recipe select fields', () => {
  ...
  it('selects only the required recipe fields – no wildcard', async () => {
    ...
    expect(mockSelect).toHaveBeenCalledWith(
      'id, user_id, name, name_en, name_translated, emoji, image_url, ingredients, steps, ingredients_translated, steps_translated, time, tags, required_ingredients, is_ai, is_public, author_name, author_email',
    );
  });
});
